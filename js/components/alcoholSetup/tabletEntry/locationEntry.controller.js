(function() {
  "use strict";
	...
	function addEditLocationsController($uibModalInstance, api, alertService, locations, restaurant_id) {
	...
	addEditLocationsController.$inject = ["$uibModalInstance", "api", "alertService", "locations", "restaurant_id"];
  
	angular
    .module("inspinia")
    .controller("addEditLocationsController", addEditLocationsController);
})();